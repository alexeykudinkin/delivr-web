...
trackingMapOverlay = angular.module "TrackingMapOverlayModule", [ "TrackingMarkerModule" ]

#define ["marker", "storage", "leaflet"], (Marker, Storage, Leaflet) ->

trackingMapOverlay.factory "TrackingMapOverlay", [ "TrackingMarker", (Marker) ->
...
#        console.log marker
    ...
    wrapForMap: (latLng) ->
      ...
      offset = center.lng - center.lng
      if (offset != 0)
        #return new Leaflet.LatLng(latLng.lat, latLng.lng + offset)
        return new google.maps.LatLng(latLng.lat, latLng.lng + offset);
      else
        return latLng
